...
# 案例分析
## 范围
- 系统规划：可行性分析、遗留系统的处理策略
- 需求获取和分析：需求获取方法、面向对象分析、结构化分析
- 系统分析：业务流程分析、系统可靠性分析
- 系统设计：结构化建模技术（数据流图）、面向对象建模技术（UML）
- 数据库建模：E-R模型、规范化、并发控制和死锁
...
- 联合需求计划：与开发团队一起讨论，快速迭代和用户紧密参与的项目
- 采样：选取特定的用户群体分析他们的行为或需求
- 问卷调查：快速收集广泛群众的基本需求
- 阅读历史文档：有成熟的文档，适用于需要对系统进行升级或替换
- 现场观摩：理解用户行为和工作流程

### 面向对象分析
基于对象和类的概念，强调实体的属性和行为，高内聚低耦合的特点，支持复用

### 结构化分析
基于功能分解，强调系统的输入、处理和输出，侧重于系统的处理逻辑

数据流图、实体-关系图、状态转换图、控制流图
## 系统分析
### 业务流程分析
